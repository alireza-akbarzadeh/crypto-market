...
type PropTypes = {};
export default function PrivacyPolicyView(props: PropTypes) {
  return (
    <>
      <Container sx={{ py: 8 }}>
        <strong>Privacy Policy</strong>
        <p>
          Crypto INC built the Crypto app as a Free app. This SERVICE is
          provided by Crypto INC at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Crypto unless otherwise
        ...
        <p>
          ...
          including but not limited to personal information, identity docs. The
        ...
        <p>
          ...
          not hesitate to contact us at business@crypto.me.
        </p>
        <p>
